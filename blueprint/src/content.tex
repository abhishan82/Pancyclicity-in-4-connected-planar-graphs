...
\begin{lemma}[Internal dual of 2-connected outerplanar is a tree]
  ...
  \lean{OuterplaneGraph.internalDual_isTree}
...
\begin{definition}[Hamiltonian decomposition $(G, C, G_0, G_1)$]
  ...
  \lean{PlaneGraph.HamiltonianDecomp}
...
\begin{definition}[Internal dual trees $T_0, T_1$]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.internalDualTrees}
...
\begin{definition}[Weight function $w$]
  \label{def:weight_w}
  \lean{PlaneGraph.HamiltonianDecomp.weight_w}
...
\begin{proposition}[Sum of weights]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.sum_weight_eq}
...
\begin{definition}[Weight function $w'$]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.weight_wprime}
  \uses{def:face}
  \notready
...
\begin{corollary}[Sum of $w'$]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.sum_wprime_eq}
...
\begin{lemma}[Lemma 3.1: Outerplane cycle enumeration]
  ...
  \lean{OuterplaneGraph.cycles_of_distinct_lengths}
...
\begin{definition}[Face counting notation]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.FaceCounts}
...
\begin{lemma}[5-tree counting]
  ...
  \lean{PlaneGraph.FiveTree.member_count}
  \uses{def:five_tree}
  \notready
...
\begin{lemma}[Lemma 4.1: Upper bound on $s^{>5}$]
  ...
  \lean{PlaneGraph.discharging_bound}
...
\begin{definition}[Leaf-triangle]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.LeafTriangle}
  \uses{def:ham_decomp, def:face}
  \notready
...
\begin{definition}[Well-triangulated vertex]
  ...
  \lean{PlaneGraph.isWellTriangulated}
  \uses{def:face}
  \notready
...
\begin{lemma}[Lemma 5.1: Enumeration lemma]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.enumeration_lemma}
...
\begin{corollary}[Corollary 5.2]
  ...
  \lean{PlaneGraph.wellTriangulated_cycle_enumeration}
...
\begin{proposition}[Edge bound]
  ...
  \lean{PlaneGraph.edge_bound_no_four_cycles}
...
\begin{proposition}[Chord bound]
  ...
  \lean{OuterplaneGraph.chord_bound_no_four_cycles}
...
\begin{lemma}[Leaf-triangle bound]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.leaf_triangle_bound}
...
\begin{corollary}[Leaf-triangle corollary]
  ...
  \lean{PlaneGraph.HamiltonianDecomp.leaf_triangle_corollary}
